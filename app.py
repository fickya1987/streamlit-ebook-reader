...
# Function to display story in a specified column
...
Batik Tradisiku generates a monthly revenue of approximately 100-200 million IDR. To double the current production capacity, Mr. Siswaya is seeking an investment of 400-500 million IDR. Potential investors who are interested in this promising business in Bogor can contact him at +62 81588xxxxxx or (0251)8374xxxx. Mr. Siswaya is offering a 50:50 profit-sharing scheme, with 50% of the profits going to the investor and 50% to Mr. Siswaya. The expected payback period for the investment is around 2 to 3 years.""",
    ...
    {
        "id": "story2",
        "title": "Denji the Fisherman",
        "summary": "Mr. Denji has been a seaweed farmer and fisherman and want to expand his seaweed cultivation in Indonesia",
        "full_text": """Mr. Denji has been a seaweed farmer and fisherman for 35 years in Selayar, South Sulawesi. He typically produces between 700 kg and 1 ton of seaweed per harvest, which takes about 1.5 to 2 months. Mr. Denji sells his seaweed for prices ranging from 25,000 to 38,000 Rupiah per kilogram, earning an average of 20-30 million Rupiah per harvest. He previously took a small business loan of 5 million Rupiah from a private bank, followed by a larger loan of 30 million Rupiah to buy ropes, seaweed seeds, and seedlings. Now, Mr. Denji aims to expand his seaweed cultivation to achieve a harvest of 2 to 4 tons per cycle. He needs additional capital of at least 100 million Rupiah. For investors interested in Mr. Denji's seaweed business in Selayar, South Sulawesi, you can contact him at +62 85738xxxxxx or visit him at Bungaiya Village, Polong Hamlet, No. 123, Block Z, South Sulawesi. Mr. Denji is offering a 60:40 profit-sharing scheme, with 60% of the profits going to the investor and 40% to himself. The expected payback period for the investment is approximately 1.5 to 2 years.""",      
        "image": "https://cm4-production-assets.s3.amazonaws.com/1716503270613-matagimage-5.png"
    },
    {
        "id": "story3",
...
# Loop through stories and display each in one of the columns
for i, story in enumerate(stories):
    display_story(story, columns[i % 3])
